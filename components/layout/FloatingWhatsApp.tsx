...
export function FloatingWhatsApp() {
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
          className="fixed z-40 flex items-center group"
          style={{
        ...
        >
          ...
          {/*
           * The circular button is a standalone <a> with its own
           * flex items-center justify-center so the icon is always
           * mathematically centred regardless of the label span.
           * Desktop: 58×58px  |  Mobile: 52×52px
           * Icon:    28×28px  |          25×25px
           */}
          <a
            href={whatsappUrl}
            target="_blank"
            ...
            className="flex items-center justify-center w-[52px] h-[52px] md:w-[58px] md:h-[58px] rounded-full bg-[#25D366] text-white shadow-lg transition-transform duration-300 ease-out group-hover:scale-105 group-active:scale-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-green-500"
          >
            {/* Official WhatsApp SVG — viewBox 0 0 24 24, centred path */}
            <svg
              viewBox="0 0 24 24"
              className="block w-[27px] h-[27px] md:w-[29px] md:h-[29px] shrink-0 fill-current"
